 ...
 * @returns {Promise<import('@cortex-os/data-provider').Agent|null>}
 */
let getAgent;
 ...
 * @param {import('@cortex-os/data-provider').TConversation} params.conversation - The added conversation
 * @param {import('@cortex-os/data-provider').Agent} [params.primaryAgent] - The primary agent (used to duplicate tools when both are ephemeral)
 * @returns {Promise<import('@cortex-os/data-provider').Agent|null>} The agent config as a plain object, or null if invalid.
 */
