...
const { getTransactionSupport, logger } = require('@cortex-os/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('@cortex-os/data-provider');
const {
...
/**
 * @import { TPrincipal } from '@cortex-os/data-provider'
 */
/**
