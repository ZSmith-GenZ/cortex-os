...
const { loadYaml } = require('@cortex-os/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'cortex-os.yaml');
...
https://www.cortexos.ai/docs/configuration/stt_tts`);
    }
