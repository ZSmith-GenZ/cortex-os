...
const { hashToken, getRandomValues, createModels } = require('@cortex-os/data-schemas');
const {
  SystemRoles,
  ResourceType,
  AccessRoleIds,
...
const VALID_STREAMING_EVENT_TYPES = new Set([
  ...
  'error',
  // Cortex OS extension events (prefixed per Open Responses spec)
  // @see https://openresponses.org/specification#extending-streaming-events
  'cortex-os:attachment',
]);
