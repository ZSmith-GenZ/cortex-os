...
const { isEnabled, getBalanceConfig } = require('@cortex-os/api');
const { Constants, CacheKeys, defaultSocialLogins } = require('@cortex-os/data-provider');
...
router.get('/', async function (req, res) {
  ...
  try {
    ...
    /** @type {TStartupConfig} */
    const payload = {
      appTitle: process.env.APP_TITLE || 'Cortex OS',
