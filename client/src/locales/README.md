# Cortex OS Localization Guide

This guide explains how to add new languages to Cortex OS's localization system.

## Adding a New Language

To add a new language to Cortex OS, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [Cortex OS locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through Cortex OS's automated translation platform
