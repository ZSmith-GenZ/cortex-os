...
import { TooltipAnchor, Button, NewChatIcon, useMediaQuery } from '@cortex-os/client';
import { PermissionTypes, Permissions, QueryKeys } from '@cortex-os/data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | Cortex OS`);
