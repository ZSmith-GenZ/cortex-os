...
jest.mock('@cortex-os/data-provider', () => {
  const actualModule = jest.requireActual('@cortex-os/data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('@cortex-os/data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from '@cortex-os/data-provider';
