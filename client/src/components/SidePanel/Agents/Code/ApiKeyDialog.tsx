import { OGDialogTemplate, Input, Button, OGDialog } from '@cortex-os/client';
        ...
        main={
          <>
            <div className="mb-4 text-center font-medium">
              {localize('com_ui_cortex-os_code_api_title')}
            </div>
            <div className="mb-4 text-center text-sm">
              {localize('com_ui_cortex-os_code_api_subtitle')}
            </div>
            ...
            <div className="mb-6">
              ...
              >
                {localize('com_ui_cortex-os_code_api_key')}
              </a>
            </div>
