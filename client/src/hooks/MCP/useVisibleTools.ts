...
import { Constants } from '@cortex-os/data-provider';
import type { TPlugin } from '@cortex-os/data-provider';
 ...
 * Separates regular Cortex OS tools from MCP servers.
 *
 * @param selectedToolIds - Array of selected tool IDs
 * @param regularTools - Array of regular Cortex OS tools
