...
import type { JsonSchemaType } from '@cortex-os/data-schemas';
...
export class MCPServerInspector {
  ...
  /**
   * Converts server tools to Cortex OS-compatible tool functions format.
   * @param serverName - The name of the server
   * @param connection - The MCP connection
   * @returns Tool functions formatted for Cortex OS
   */
