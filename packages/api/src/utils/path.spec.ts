...
describe('getBasePath', () => {
  ...
  it('should return base path for subdirectory deployment', () => {
    ...
    expect(getBasePath()).toBe('/cortex-os');
  });
  ...
  it('should handle nested subdirectories', () => {
    ...
    expect(getBasePath()).toBe('/apps/cortex-os');
  });
  ...
  it('should handle URLs with query parameters', () => {
    process.env.DOMAIN_CLIENT = 'http://localhost:3080/cortex-os?param=value';
    expect(getBasePath()).toBe('/cortex-os');
  });

  it('should handle URLs with fragments', () => {
    process.env.DOMAIN_CLIENT = 'http://localhost:3080/cortex-os#section';
    expect(getBasePath()).toBe('/cortex-os');
  });
  ...
  it('should handle URLs with ports', () => {
    process.env.DOMAIN_CLIENT = 'http://localhost:8080/cortex-os';
    expect(getBasePath()).toBe('/cortex-os');
  });

  it('should handle URLs with subdomains', () => {
    process.env.DOMAIN_CLIENT = 'https://app.example.com/cortex-os';
    expect(getBasePath()).toBe('/cortex-os');
  });
});
