...
describe('extractCortexOSParams', () => {
  ...
  it('should extract all Cortex OS params and leave model options', () => {
    const options = {
      resendFiles: false,
  ...
  it('should handle null values for Cortex OS params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Cortex OS params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should handle undefined values for optional Cortex OS params', () => {
    const options = {
      resendFiles: false,
