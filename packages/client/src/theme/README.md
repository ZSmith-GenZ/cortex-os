# Dynamic Theme System for @cortex-os/client
...
```bash
npm install @cortex-os/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@cortex-os/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@cortex-os/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@cortex-os/client';
...
```tsx
import { useTheme } from '@cortex-os/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@cortex-os/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@cortex-os/client';
...
This theme system is part of the @cortex-os/client package. 