...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'cortex-os-westus'
    expect(groupMap).toHaveProperty('cortex-os-westus');
    expect(groupMap['cortex-os-westus']).toEqual(
    ...
    // Check groupMap for 'cortex-os-eastus'
    expect(groupMap).toHaveProperty('cortex-os-eastus');
    expect(groupMap['cortex-os-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'cortex-os-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'cortex-os-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'cortex-os-eastus',
