import { EModelEndpoint, agentsEndpointSchema } from '@cortex-os/data-provider';
import type { TCustomConfig, TAgentsEndpoint } from '@cortex-os/data-provider';

/**
 * Sets up the Agents configuration from the config (`cortex-os.yaml`) file.
