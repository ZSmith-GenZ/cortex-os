...
import { EModelEndpoint, normalizeEndpointName } from '@cortex-os/data-provider';
import type { TCustomConfig } from '@cortex-os/data-provider';

/**
 * Sets up Model Specs from the config (`cortex-os.yaml`) file.
...
For more information, see the documentation at https://www.cortexos.ai/docs/configuration/cortex-os_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
