...
(async () => {
  ...
  console.purple('Removing all tags for Cortex OS `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/cortex-os-dev-api', 'cortex-os-client'];
  ...
  console.purple('Pulling latest Cortex OS images...');
