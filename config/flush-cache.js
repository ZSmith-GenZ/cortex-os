...
/**
 * Cortex OS Cache Flush Utility
 *
 * This script flushes the cache store used by Cortex OS, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Cortex OS. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Cortex OS backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Cortex OS Cache Flush Utility');
  console.log('================================');
