...
const { getBalanceConfig } = require('@cortex-os/api');
const { User, Balance } = require('@cortex-os/data-schemas').createModels(mongoose);
...
(async () => {
  ...
  if (!balanceConfig?.enabled) {
    console.red('Error: Balance is not enabled. Use cortex-os.yaml to enable it');
    silentExit(1);
  }
